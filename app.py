...
# Function for Xception model
def xception_classification():
    st.title("Xception Image Classification")
...
def main():
    ...
    choice = st.sidebar.selectbox("Choose Model", ("CIFAR-10", "MobileNetV2 (ImageNet)", "Xception"))
